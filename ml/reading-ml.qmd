...
- **Maechler, M., Rousseeuw, P., Struyf, A., Hubert, M., & Hornik, K. (2025). *cluster: Cluster Analysis Basics and Extensions.*  R package version 2.1.8.**  
  The main R package for clustering, providing implementations of many of the methods described in Kaufman & Rousseeuw (2005), along with practical extensions and tools for applied work. Available online^[[https://cran.r-project.org/package=cluster](https://cran.r-project.org/package=cluster)].
