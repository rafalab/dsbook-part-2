...
1\. From the previous chapter, you have already computed the expected value, standard deviation, and probability distribution for betting on green 100 times (exercises 9-12 in @sec-random-variables). Now apply the Central Limit Theorem to betting on green 1,000 times.
