...
If we know the true relative frequencies of the different categories---that is, the proportions of each category out of all possible outcomes---defining a distribution for categorical outcomes is relatively straightforward. We simply assign each relative frequency as the probability of its respective category. In cases analogous to beads in an urn, for each bead type, its proportion defines the distribution.
