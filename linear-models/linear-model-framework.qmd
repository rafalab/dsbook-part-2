...
9\. Fit a regression model to each of the datasets in the Anscombe quartet introduced in the previous chapter (`anscombe` dataset) and examine the diagnostic plots.
