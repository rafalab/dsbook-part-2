...
7\. Divide the log odds ratio estimates by their respective standard errors and generate a qq-plot comparing these to a standard normal. Do any of the disciplines deviate from what is expected by chance?
