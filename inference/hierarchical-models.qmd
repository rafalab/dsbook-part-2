...
16\. We are now ready to compute the distribution of $\theta$ conditioned on the observed data $\bar{Y}$. Compute the expected value of $\theta$ given the current average $\bar{Y}$, and provide an intuitive explanation for the mathematical formula.
