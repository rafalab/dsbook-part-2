...
We can also report intervals with high probability of occurring given our model. Specifically, for any probability value $\alpha$ we can use the posterior distribution to construct intervals centered at our posterior mean and with $\alpha$ chance of occurring. These are called _credible intervals_. 
