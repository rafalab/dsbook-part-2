...
The standard deviation of a random variable is often called the *standard error* of the estimate, and it quantifies how much the estimate is expected to vary from one sample to another. The smaller the standard error, the more precise our estimate is. We can also use what we learned to determine the standard deviation: 
$$
