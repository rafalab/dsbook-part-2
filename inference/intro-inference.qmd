...
In 2016, Silver was not as certain and gave Hillary Clinton only a 71% chance of winning. In contrast, many other forecasters were almost certain she would win. She lost. But 71% is still more than 50%, so was Mr. Silver wrong? And what does probability mean in this context anyway? 
...
We conclude with two widely taught topics that, while not required for the case study, are central to statistical practice: statistical power and p-values. This part of the book ends with a brief introduction to the bootstrap, an inferential method we will revisit in the machine learning part.
